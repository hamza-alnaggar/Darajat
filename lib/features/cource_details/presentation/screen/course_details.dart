...
class _CourseDetailsState extends State<CourseDetails> {
  ...
  final sections = List.generate(6, (i) => Section(
    title: 'Section ${i+1} – Title here',
    lectures: List.generate(5, (j) => Lecture(
      title: 'Lecture ${j+1}',
      length: '0${j+1}:00 mins',
      isVideo: j.isEven,
    )),
  ));
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Icon(Icons.translate, size: 20.r, color: CustomColors.textSecondary),
                      SizedBox(width: 7.w),
                      Expanded(
                        child: RichText(
                          text: TextSpan(
                            children: [
                              TextSpan(text: "English, Arabic, ",style: theme.bodySmall),
                              TextSpan(
                                text: "26 more",
                                style: TextStyle(color: Colors.purpleAccent, fontWeight: FontWeight.bold),
                              ),
              ...
              (context, index) => Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        "You will learn how to create games and programs in Python",
            ...
            delegate: SliverChildBuilderDelegate((context, index) {
              ...
              return Padding(
                ...
                child: ExpansionTile(
                  ...
                  trailing: Icon(
                    section.isOpen ? Icons.remove : Icons.add,
                    color: Colors.purpleAccent.shade100,
                  ),
                  backgroundColor: isDark ?CustomColors.backgroundColor:Colors.white,
                  collapsedBackgroundColor: isDark ?CustomColors.backgroundColor:Colors.white,
                  shape: Border.all(color: isDark?CustomColors.backgroundColor:Colors.white),
                  title: Text(
                    section.title,
                    style: TextStyle(color:isDark? Colors.white70 : CustomColors.black, fontSize: 16.sp),
                  ),
                  childrenPadding: EdgeInsets.only(left: 16.w, bottom: 8.h),
                  onExpansionChanged: (open) {
                    setState(() => section.isOpen = open);
                  },
                  children: section.lectures.map((lec) {
                    return ListTile(
                      dense: true,
                      horizontalTitleGap: 5,
                      trailing: Icon(Icons.play_circle,color: Colors.purpleAccent.shade100,),
                      visualDensity: VisualDensity(vertical: -4),
                      contentPadding: EdgeInsets.only(left: 25.w,right: 10.w),
                      leading:Text('1',style: theme.titleMedium,),
                      title: Padding(
                      ...
                      subtitle: Text(
                        "Video - 06:39 mins",
                        style: TextStyle(color:isDark? Colors.white70 : CustomColors.dark, fontSize: 12.sp),
                      ),
                    );
                  }).toList(),
                ),
      ...
      child: Column(
        ...
        SizedBox(
          ...
          Text("Student Feedback",style: theme.headlineSmall?.copyWith(fontSize: 20.sp,fontWeight: FontWeight.bold,)), 
              ...
              for (int stars = 5; stars >= 1; stars--) _buildRatingBar(stars,theme,context),
              SizedBox(height: 32.h),
              ...reviews.map((rev) => _buildReviewTile(rev,theme)),
        ],
      ),
    )
          )
...
class Lecture {
 ...
 Widget _buildIncludeRow(IconData icon, String text,TextTheme theme) {
   ...
   Widget _buildRatingBar(int starCount,TextTheme theme,BuildContext context) {
          ...
          Row(
            children: List.generate(5, (index) {
              if (index < starCount) {
                ...
                return Icon(Icons.star_border, color: CustomColors.textSecondary, size: 16);
              }
            }),
          ),
          SizedBox(width: 8),
  ...
  Widget _buildReviewTile(Map<String, dynamic> rev,TextTheme theme) {
    return Padding(
